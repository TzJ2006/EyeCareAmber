...
struct Settings: Codable, Equatable {
    ...
    /// Figueiro (2019, J Biol Rhythms 34(2):178–194) 报告 2700 K 褪黑素抑制
    /// 18.4%（SEM 1.0%）、6500 K 24.7%（SEM 1.0%）。3000–4400 K 整段在已核实文献里是空白。
    ///
    /// **这两个数要按它们的本意读**：它们是跨 40–1000 lux 眼位照度 × 0.5–3 小时
    /// 全部条件的**光谱主效应边际均值**，不是某个具体条件的实测值，样本是 18 名
    /// 青少年 + 23 名成人。屏幕根本达不到那个照度量级，所以它支持的只是
    /// 「同等条件下 2700 K 比 6500 K 少抑制」这个**方向**，不能拿来推算屏幕的剂量。
    ///
